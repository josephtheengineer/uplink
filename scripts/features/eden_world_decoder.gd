...
func load_world(): ############################################################
	...
	Core.emit_signal("msg", "File is loaded! Length is " + str(Core.Server.map_file.get_len()), "Info")
...
func get_metadata(): ##########################################################
	...
	Core.emit_signal("msg", "Found " + str(Core.Server.chunk_metadata.size()) + " chunks", "Info");
	#Core.emit_signal("msg", str(Core.Server.chunk_metadata), "Trace")
